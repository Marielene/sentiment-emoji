...
#temp=vectorizer.stop_words('english', data['text'].values)
...
model = Sequential()
model.add(Embedding(10000, 30, input_length=standard))
...
print(model.summary())
 # fit model
model.fit(X_train, Y_train, epochs=10, verbose=1, validation_split=0.0001, batch_size=128)
#print(model.summary())
#Evaluate Model
...
# save the tokenizer
#dump(tokenizer, open('tokenizerSent.pkl', 'wb'))
>>>>>>> 6e5f14238ff2b064d58bfb5962ee365eca3822f2
